...
public class contractChartsAnnonces {
    public static void main(String[] args) {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT contrat, COUNT(*) AS count FROM annonces GROUP BY contrat");
            ...
            while (resultSet.next()) {
                ...
                if (contrat != null) {
                    ...
                    dataset.setValue(count, "Offres", contrat);
                    System.out.println(contrat + " : " + count + " offres");
                }
            }

            if (dataset.getRowCount() > 0) {
                JFreeChart chart = ChartFactory.createBarChart(
                        "Répartition des offres par type de contrat pour le site Maroc Annonces", // Titre du graphique
