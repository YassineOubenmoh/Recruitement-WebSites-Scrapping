...
public class sectorsChartsAnnonces {
    public static void main(String[] args) {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT secteur, COUNT(*) AS count FROM annonces GROUP BY secteur HAVING count > 10");
            ...
            while (resultSet.next()) {
                ...
                if (secteur != null) {
                    ...
                    dataset.setValue(count, "Entreprises", secteur);
                    System.out.println(secteur + " : " + count + " entreprises");
                }
            }

            if (dataset.getRowCount() > 0) {
                JFreeChart chart = ChartFactory.createBarChart(
                        "Répartition des entreprises par secteur d'activité pour le site Maroc Annonces (plus de 10 occurrences)", // Titre du graphique
